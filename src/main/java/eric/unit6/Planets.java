...
class Planets {
    public static void main(String args[]) {
        String[] planets = { "Mercury, the smallest", "Venus, the hottest", "Earth, our home",
                "Mars, our sister planet", "Jupiter, the biggest", "Saturn, the prettiest", "Uranus, the tilted planet",
                "Neptune, the furthest" };
        double[] diameter = { 3031, 7521, 7926, 4222, 88846, 74900, 31763, 30779 };
        double[] distance = { 36000000, 67000000, 92960000, 141700000, 483500000, 888750000, 888750000, 1783744300,
                2797770000.0 };
