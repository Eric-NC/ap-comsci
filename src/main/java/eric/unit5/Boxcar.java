...
public class Boxcar {
    ...
    // to "gizmos". The numUnits variable is set to the parameter u. If u is less
    // than
    // 0 or higher than the maximum capacity of 10 units, numUnits is set to 0. The
    // repair
    ...
    public String toString() {
        ...
        return numUnits + " " + cargo + " in " + (!repair ? "service" : "repair");
    }
    ...
    // The method ignores the case of of the value in c. If c holds any value other
    // than
