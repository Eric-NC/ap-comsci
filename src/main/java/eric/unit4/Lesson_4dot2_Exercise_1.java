...
/*
 ...
 When the two number meet the requirements, use a for loop to print all of the numbers from the first number to the second number, 
 with 10 numbers on each line. Print one space between each number.
 Sample run
Please enter a number in between 1 and 100:  [DrJava Input Box]
Please enter a number in between 200 and 1000:  [DrJava Input Box]
